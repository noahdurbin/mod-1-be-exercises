...
describe "#min/#max/#min_by/#max_by" do
  ...
  it "returns the name with the lowest associated value" do
    ...
    lowest_valued_name = people.min_by do |people|
        people[1]
    end
    lowest_valued_name = lowest_valued_name[0]
  ...
  it "returns the name with the highest associated value" do
    ...
    highest_valued_name = people.max_by do |people|
        people[1]
    end
    highest_valued_name = highest_valued_name[0]
