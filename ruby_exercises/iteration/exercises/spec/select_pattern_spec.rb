RSpec.describe 'select pattern' do
  ...
  it 'test 5' do
    ...
    words_with_c = []
    furniture.select do |word|
      if word.include?("c")
        words_with_c.push(word)
      end
    end
  ...
  it 'test 6' do
    ...
    words_with_c = {}
    furniture.select do |room, furniture|
  ...
  it 'test 8' do
    ...
    two_words = {}
    meal.select do |course, dish|
      if dish.split.size == 2
        two_words[course] = dish
      end
    end
